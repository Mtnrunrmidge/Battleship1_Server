...
public class Player {
    ...
    /**
     * OLD.Game.Gameboard has the placement of ships by the player
     * @param gameboard
     */
    ...
    /**
     * Set guesses By OLD.Game.Player to keep track of the guesses the player has made throughout the game
